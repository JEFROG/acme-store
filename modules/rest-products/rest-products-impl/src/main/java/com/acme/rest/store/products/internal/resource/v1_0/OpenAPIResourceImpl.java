...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "Used in Liferay 7.4 headless / react portlet example", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "API for Acme Store Example", version = "v1.0")
)
@Path("/v1.0")
