package com.acme.rest.store.products.client.serdes.v1_0;

import com.acme.rest.store.products.client.dto.v1_0.Product;
import com.acme.rest.store.products.client.json.BaseJSONParser;
...
public class ProductSerDes {
	...
	public static Map<String, String> toMap(Product product) {
		...
		if (product.getStocked() == null) {
			map.put("stocked", null);
		}
		else {
			map.put("stocked", String.valueOf(product.getStocked()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "category")) {
				if (jsonParserFieldValue != null) {
					product.setCategory(
						Product.Category.create((String)jsonParserFieldValue));
				}
			}
			...
			else if (Objects.equals(jsonParserFieldName, "stocked")) {
				if (jsonParserFieldValue != null) {
					product.setStocked((Boolean)jsonParserFieldValue);
				}
			}
		}
