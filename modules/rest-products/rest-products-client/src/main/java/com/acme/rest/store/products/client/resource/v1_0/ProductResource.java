package com.acme.rest.store.products.client.resource.v1_0;
...
import com.acme.rest.store.products.client.problem.Problem;
...
public interface ProductResource {
	...
	public static class ProductResourceImpl implements ProductResource {
		...
		public HttpInvoker.HttpResponse getProductsPageHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/rest-products/v1.0/products");
		...
		public HttpInvoker.HttpResponse postProductBatchHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port + "/o/rest-products/v1.0/products/batch");
		...
		public HttpInvoker.HttpResponse deleteProductHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/rest-products/v1.0/products/{productId}");
