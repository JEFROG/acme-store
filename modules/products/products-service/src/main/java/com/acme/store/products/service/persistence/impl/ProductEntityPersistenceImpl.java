...
package com.acme.store.products.service.persistence.impl;

import com.acme.store.products.exception.NoSuchProductEntityException;
import com.acme.store.products.model.ProductEntity;
import com.acme.store.products.model.ProductEntityTable;
import com.acme.store.products.model.impl.ProductEntityImpl;
import com.acme.store.products.model.impl.ProductEntityModelImpl;
import com.acme.store.products.service.persistence.ProductEntityPersistence;
import com.acme.store.products.service.persistence.ProductEntityUtil;
import com.acme.store.products.service.persistence.impl.constants.ACMEPersistenceConstants;
...
/**
 * The persistence implementation for the product entity service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = {ProductEntityPersistence.class, BasePersistence.class})
public class ProductEntityPersistenceImpl
	extends BasePersistenceImpl<ProductEntity>
	implements ProductEntityPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>ProductEntityUtil</code> to access the product entity persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		ProductEntityImpl.class.getName();
	 ...
	 */
	@Override
	public List<ProductEntity> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<ProductEntity> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<ProductEntity> findByUuid(
	...
	public List<ProductEntity> findByUuid(
		...
		if (useFinderCache) {
			list = (List<ProductEntity>)finderCache.getResult(
				finderPath, finderArgs);

			if ((list != null) && !list.isEmpty()) {
				for (ProductEntity productEntity : list) {
					if (!uuid.equals(productEntity.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_PRODUCTENTITY_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(ProductEntityModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<ProductEntity>)QueryUtil.list(
	...
	public ProductEntity findByUuid_First(
		...
		ProductEntity productEntity = fetchByUuid_First(
		...
		throw new NoSuchProductEntityException(sb.toString());
	}
	...
	public ProductEntity fetchByUuid_First(
		...
		List<ProductEntity> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public ProductEntity findByUuid_Last(
		...
		ProductEntity productEntity = fetchByUuid_Last(uuid, orderByComparator);
	...
	public ProductEntity fetchByUuid_Last(
		...
		List<ProductEntity> list = findByUuid(
	...
	public ProductEntity[] findByUuid_PrevAndNext(
		...
		ProductEntity productEntity = findByPrimaryKey(productId);
		...
		try {
			...
			ProductEntity[] array = new ProductEntityImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, productEntity, uuid, orderByComparator, true);

			array[1] = productEntity;

			array[2] = getByUuid_PrevAndNext(
				session, productEntity, uuid, orderByComparator, false);
	...
	protected ProductEntity getByUuid_PrevAndNext(
		Session session, ProductEntity productEntity, String uuid,
		OrderByComparator<ProductEntity> orderByComparator, boolean previous) {
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_PRODUCTENTITY_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(productEntity.uuid IS NULL OR productEntity.uuid = '')";
	...
	public ProductEntity findByUUID_G(String uuid, long groupId)
		...
		ProductEntity productEntity = fetchByUUID_G(uuid, groupId);
	...
	public ProductEntity fetchByUUID_G(
		...
		if (result instanceof ProductEntity) {
			ProductEntity productEntity = (ProductEntity)result;

			if (!Objects.equals(uuid, productEntity.getUuid()) ||
				(groupId != productEntity.getGroupId())) {
	...
	public ProductEntity removeByUUID_G(String uuid, long groupId)
		...
		ProductEntity productEntity = findByUUID_G(uuid, groupId);

		return remove(productEntity);
	}
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_2 =
		"productEntity.uuid = ? AND ";

	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(productEntity.uuid IS NULL OR productEntity.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<ProductEntity> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<ProductEntity> findByUuid_C(
	...
	public List<ProductEntity> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ProductEntity productEntity : list) {
					if (!uuid.equals(productEntity.getUuid()) ||
						(companyId != productEntity.getCompanyId())) {
	...
	public ProductEntity findByUuid_C_First(
		...
		ProductEntity productEntity = fetchByUuid_C_First(
	...
	public ProductEntity fetchByUuid_C_First(
		...
		List<ProductEntity> list = findByUuid_C(
	...
	public ProductEntity findByUuid_C_Last(
		...
		ProductEntity productEntity = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public ProductEntity[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, productEntity, uuid, companyId, orderByComparator,
				true);
	...
	protected ProductEntity getByUuid_C_PrevAndNext(
		Session session, ProductEntity productEntity, String uuid,
		long companyId, OrderByComparator<ProductEntity> orderByComparator,
		boolean previous) {
	...
	public ProductEntity findByName(String name)
		...
		ProductEntity productEntity = fetchByName(name);
	...
	public ProductEntity fetchByName(String name, boolean useFinderCache) {
		...
		if (result instanceof ProductEntity) {
			...
			if (!Objects.equals(name, productEntity.getName())) {
				result = null;
			}
		}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ProductEntityPersistenceImpl.fetchByName(String, boolean) with parameters (" +
	...
	public ProductEntity removeByName(String name)
		...
		ProductEntity productEntity = findByName(name);
	...
	private static final String _FINDER_COLUMN_NAME_NAME_3 =
		"(productEntity.name IS NULL OR productEntity.name = '')";
	...
	public ProductEntity findByCategory(int category)
		...
		ProductEntity productEntity = fetchByCategory(category);
	...
	public ProductEntity fetchByCategory(int category, boolean useFinderCache) {
		...
		if (useFinderCache) {
			result = finderCache.getResult(
				_finderPathFetchByCategory, finderArgs);
		}

		if (result instanceof ProductEntity) {
			ProductEntity productEntity = (ProductEntity)result;

			if (category != productEntity.getCategory()) {
				result = null;
			}
		}
				...
				if (list.isEmpty()) {
					...
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							...
							_log.warn(
								"ProductEntityPersistenceImpl.fetchByCategory(int, boolean) with parameters (" +
									StringUtil.merge(finderArgs) +
										") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
	...
	public ProductEntity removeByCategory(int category)
		...
		ProductEntity productEntity = findByCategory(category);
	...
	public ProductEntityPersistenceImpl() {
		...
		setModelClass(ProductEntity.class);

		setModelImplClass(ProductEntityImpl.class);
		setModelPKClass(long.class);

		setTable(ProductEntityTable.INSTANCE);
	}
	...
	public void cacheResult(ProductEntity productEntity) {
		entityCache.putResult(
			ProductEntityImpl.class, productEntity.getPrimaryKey(),
			productEntity);

		finderCache.putResult(
			_finderPathFetchByUUID_G,
			new Object[] {productEntity.getUuid(), productEntity.getGroupId()},
			productEntity);

		finderCache.putResult(
			_finderPathFetchByName, new Object[] {productEntity.getName()},
			productEntity);

		finderCache.putResult(
			_finderPathFetchByCategory,
			new Object[] {productEntity.getCategory()}, productEntity);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<ProductEntity> productEntities) {
		if ((_valueObjectFinderCacheListThreshold == 0) ||
			((_valueObjectFinderCacheListThreshold > 0) &&
			 (productEntities.size() > _valueObjectFinderCacheListThreshold))) {
	...
	/**
	 * Clears the cache for all product entities.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(ProductEntityImpl.class);

		finderCache.clearCache(ProductEntityImpl.class);
	}

	/**
	 * Clears the cache for the product entity.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(ProductEntity productEntity) {
		entityCache.removeResult(ProductEntityImpl.class, productEntity);
	}

	@Override
	public void clearCache(List<ProductEntity> productEntities) {
		for (ProductEntity productEntity : productEntities) {
			entityCache.removeResult(ProductEntityImpl.class, productEntity);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(ProductEntityImpl.class, primaryKey);
		}
	}

	protected void cacheUniqueFindersCache(
		ProductEntityModelImpl productEntityModelImpl) {

		Object[] args = new Object[] {
			productEntityModelImpl.getUuid(),
			productEntityModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, productEntityModelImpl);

		args = new Object[] {productEntityModelImpl.getName()};

		finderCache.putResult(_finderPathCountByName, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByName, args, productEntityModelImpl);

		args = new Object[] {productEntityModelImpl.getCategory()};

		finderCache.putResult(
			_finderPathCountByCategory, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByCategory, args, productEntityModelImpl);
	}
	...
	public ProductEntity create(long productId) {
		ProductEntity productEntity = new ProductEntityImpl();

		productEntity.setNew(true);
		productEntity.setPrimaryKey(productId);

		String uuid = PortalUUIDUtil.generate();

		productEntity.setUuid(uuid);

		productEntity.setCompanyId(CompanyThreadLocal.getCompanyId());
	 ...
	 * Removes the product entity with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the product entity
	 * @return the product entity that was removed
	 * @throws NoSuchProductEntityException if a product entity with the primary key could not be found
	 */
	@Override
	public ProductEntity remove(Serializable primaryKey)
		throws NoSuchProductEntityException {
		...
		try {
			...
			ProductEntity productEntity = (ProductEntity)session.get(
				ProductEntityImpl.class, primaryKey);
			...
			if (productEntity == null) {
				...
				throw new NoSuchProductEntityException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(productEntity);
		}
		catch (NoSuchProductEntityException noSuchEntityException) {
	...
	@Override
	protected ProductEntity removeImpl(ProductEntity productEntity) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(productEntity)) {
				productEntity = (ProductEntity)session.get(
					ProductEntityImpl.class, productEntity.getPrimaryKeyObj());
			}
	...
	public ProductEntity updateImpl(ProductEntity productEntity) {
		boolean isNew = productEntity.isNew();

		if (!(productEntity instanceof ProductEntityModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(productEntity.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(
					productEntity);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in productEntity proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom ProductEntity implementation " +
					productEntity.getClass());
		}

		ProductEntityModelImpl productEntityModelImpl =
			(ProductEntityModelImpl)productEntity;

		if (Validator.isNull(productEntity.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (productEntity.getCreateDate() == null)) {
			if (serviceContext == null) {
				productEntity.setCreateDate(date);
			}
			else {
				productEntity.setCreateDate(serviceContext.getCreateDate(date));
			}
		}

		if (!productEntityModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				productEntity.setModifiedDate(date);
			}
			else {
		...
		try {
			...
			if (isNew) {
				...
				productEntity = (ProductEntity)session.merge(productEntity);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		entityCache.putResult(
			ProductEntityImpl.class, productEntityModelImpl, false, true);

		cacheUniqueFindersCache(productEntityModelImpl);

		if (isNew) {
			productEntity.setNew(false);
		}

		productEntity.resetOriginalValues();

		return productEntity;
	}

	/**
	 * Returns the product entity with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the product entity
	 ...
	 */
	@Override
	public ProductEntity findByPrimaryKey(Serializable primaryKey)
		throws NoSuchProductEntityException {

		ProductEntity productEntity = fetchByPrimaryKey(primaryKey);
	 ...
	 */
	@Override
	public List<ProductEntity> findAll(int start, int end) {
	...
	public List<ProductEntity> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_PRODUCTENTITY);
				...
				sql = _SQL_SELECT_PRODUCTENTITY;

				sql = sql.concat(ProductEntityModelImpl.ORDER_BY_JPQL);
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_PRODUCTENTITY);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_PRODUCTENTITY;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return ProductEntityModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the product entity persistence.
	 */
	@Activate
	public void activate() {
		...
		_finderPathFetchByCategory = new FinderPath(
			FINDER_CLASS_NAME_ENTITY, "fetchByCategory",
			new String[] {Integer.class.getName()}, new String[] {"category"},
			true);
		...
		_setProductEntityUtilPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		_setProductEntityUtilPersistence(null);

		entityCache.removeCache(ProductEntityImpl.class.getName());
	}

	private void _setProductEntityUtilPersistence(
		ProductEntityPersistence productEntityPersistence) {

		try {
			Field field = ProductEntityUtil.class.getDeclaredField(
				"_persistence");

			field.setAccessible(true);

			field.set(null, productEntityPersistence);
		}
	...
	private static final String _SQL_SELECT_PRODUCTENTITY =
		"SELECT productEntity FROM ProductEntity productEntity";

	private static final String _SQL_SELECT_PRODUCTENTITY_WHERE =
		"SELECT productEntity FROM ProductEntity productEntity WHERE ";

	private static final String _SQL_COUNT_PRODUCTENTITY =
		"SELECT COUNT(productEntity) FROM ProductEntity productEntity";

	private static final String _SQL_COUNT_PRODUCTENTITY_WHERE =
		"SELECT COUNT(productEntity) FROM ProductEntity productEntity WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "productEntity.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No ProductEntity exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No ProductEntity exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		ProductEntityPersistenceImpl.class);
	...
	@Reference
	private ProductEntityModelArgumentsResolver
		_productEntityModelArgumentsResolver;
